          ...
          {blogs.map((blog) =>  (
             ...
             <div>   
               <BlogBox  
                 ...
                 date={blog.date}
                 interaction={ <button onClick={incrementCount}><AiFillLike size={20} color="#9bbed6" /> {count}</button> }
     ...
     <center>
      ...
      <fieldset>
        ...
        <div className="butt">
          ...
          <button onClick={() => navigate("/contact")}><RiContactsFill size={20} color="#9bbed6"/></button>
